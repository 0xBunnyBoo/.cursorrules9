...
Don't pipe your commands. Just print them out when you run them in the console. Then I can see the errors and help you.

There are other agents working on stuff. If you see things change or linter issues, it's probably work in progress. don't revert. try to ignore it unless you're sure it's just an issue that needs to be fixed.
